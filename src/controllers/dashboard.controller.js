...
async function exportar(){
  try{
    const r=await fetch(API+'/api/admin/export',{method:'POST',headers:{Authorization:'Bearer '+T,'Content-Type':'application/json'},body:JSON.stringify({format:'csv',fields:['name','email','phone','cardCode','totalStamps','createdAt']})});
